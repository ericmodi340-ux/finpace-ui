...
export default function AdvisorOnboardingStepper({ handleClose }: { handleClose: VoidFunction }) {
  ...
  const steps = [
    {
      ...
      description:
        'Finpace helps you save time onboarding and managing your clients and documents, all while staying compliant.',
